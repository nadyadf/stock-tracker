...
const Register = {
      ...
      <section class="register-container">
        <div class="col-xs-12 col-sm-6">
          <form class="omb_loginForm" action="" autocomplete="off">
            <h3 class="omb_authTitle">Daftar</h3>
            ...
            <button class="btn btn-lg btn-primary btn-block submit-btn">Daftar</button>
  ...
  async afterRender() {
    ...
    submitButton.addEventListener('click', async (e) => {
      ...
      const response = await StockTrackerResource.register(username, password);
